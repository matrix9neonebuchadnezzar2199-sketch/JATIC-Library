...
Windows 向け **PyInstaller onedir** ビルド。`build.bat` で Chromium をダウンロードして `_internal/ms-playwright` に同梱し、`JATIC-Library-*-win64.zip` を生成（zip はおおよそ **450〜550 MB**）。初回のブラウザ DL は不要。
