...
<p align="center">
  ...
  <a href="docs/DEV_STATUS.md"><img src="https://img.shields.io/badge/status-v0.1.0--beta.1-blue?style=flat-square" alt="Status"></a>
</p>
...
> **現在のリリース:** [v0.1.0-beta.1](docs/RELEASE_v0.1.0-beta.1.md)（pre-release）— 配布 zip は `build.bat` で生成。手順は [BETA_TEST.md](docs/BETA_TEST.md)、操作は [USER_MANUAL.md](docs/USER_MANUAL.md)。
...
Windows 向け **PyInstaller onedir** ビルド。`build.bat` で `JATIC-Library-0.1.0-beta.1-win64.zip` を生成。Playwright **driver** は同梱、Chromium は初回にアプリ内セットアップ（[INST_27](docs/instructions/INST_27_playwright_first_run_setup.md)）。

---

## スクリーンショット

> ベータ版の画面キャプチャは [INST_30](docs/instructions/INST_30_release_docs.md) 以降で追加予定です。
...
**ベータ exe:** `dist/JATIC-Library/JATIC-Library.exe`（フォルダ一式必須）— zip は `dist/JATIC-Library-0.1.0-beta.1-win64.zip`。手順は [docs/BETA_TEST.md](docs/BETA_TEST.md)。
...
| [docs/USER_MANUAL.md](docs/USER_MANUAL.md) | ユーザーマニュアル（v0.1.0-beta.1） |
| [docs/BETA_TEST.md](docs/BETA_TEST.md) | ベータ利用者向け手順 |
| [docs/RELEASE_v0.1.0-beta.1.md](docs/RELEASE_v0.1.0-beta.1.md) | リリースノート |
